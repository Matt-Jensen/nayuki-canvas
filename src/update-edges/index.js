...
* @return {Array}
*/
export default function updateEdges (nodes = this._nodes, edges = this.edges, maxExtraEdges = this._maxExtraEdges, radiiWeightPower = this._radiiWeightPower, getOpacity = this._getOpacity) {
  const newEdges = [];
